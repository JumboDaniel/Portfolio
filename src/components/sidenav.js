...
const Navbar = () => {
    ...
    return (
      <div className="px-4 py-10 pt-10 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8">
        <div className="relative flex items-center justify-between">
          ...
          >
            ...
            <span className="ml-2 text-xl font-bold tracking-wider text-gray-800 uppercase">
              Jumbo Daniel
            </span>
          </Link>
                ...
                <div className="p-5 bg-white border rounded shadow-sm">
                  <div className="flex items-center justify-between mb-4">
                    <div>
                      ...
                      >
                        ...
                        <span className="ml-2 text-xl font-bold tracking-widest text-gray-800 uppercase">
                          Jumbo Daniel
                        </span>
                      </a>
                    </div>
                  ...
                  <nav>
                    <ul className="space-y-4">
                      ...
                      <li>
                      <li>
                          <Link to='/designs' className='font-medium tracking-wide text-gray-700 transition-colors duration-200 hover:text-deep-purple-accent-400'>Designs</Link>
                      </li>
                      </li>
                      <li>
                      <li>
